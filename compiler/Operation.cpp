...
void LdConst::gen_txt(std::ostream& o) {
...
void Copy::gen_txt(std::ostream& o) {
...
void Add::gen_txt(std::ostream& o) {
...
void Sub::gen_txt(std::ostream& o) {
...
void Mul::gen_txt(std::ostream& o) {
...
void Rmem::gen_txt(std::ostream& o) {
...
void Wmem::gen_txt(std::ostream& o) {
...
void Call::gen_txt(std::ostream& o) {
...
void CmpEq::gen_txt(std::ostream& o) {
...
void CmpLt::gen_txt(std::ostream& o) {
...
void CmpLe::gen_txt(std::ostream& o) {
